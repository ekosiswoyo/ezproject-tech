	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				'tech-cyan-glow': 'hsl(var(--tech-cyan-glow))',
				'tech-text': 'hsl(var(--tech-text))',
				'tech-text-muted': 'hsl(var(--tech-text-muted))',
			},
			borderRadius: {
				lg: 'var(--radius)',
			...
			backgroundImage: {
				...
				'tech-gradient': 'linear-gradient(135deg, hsl(var(--tech-dark)) 0%, hsl(var(--tech-blue)) 100%)',
				'accent-gradient': 'linear-gradient(135deg, hsl(var(--tech-cyan)) 0%, hsl(var(--tech-cyan-glow)) 100%)',
			}
		}
	},
